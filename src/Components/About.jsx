...
const About = () => {
  ...
  return (
    <div className='about' id="about">
      ...
      <div className="words">
        <p>
          I'm an {calculate_age()}-year-old full stack developer who loves making life easier and more enjoyable by tackling problems with code. I am an open source enthusiast eager to contribute to the tech community in whatever way I can
        </p>
        <p>
